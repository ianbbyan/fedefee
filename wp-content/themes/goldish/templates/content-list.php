...
<article
	...
	<?php } ?>
		...
		<?php if ( ideapark_mod( 'post_layout' ) == 'grid' ) { ?>
		<div class="c-post-list__bottom-wrap">
			...
			<?php } else { ?>
				<div class="c-post-list__meta-category"></div>
			<?php } ?>
			...
			<a class="c-post-list__continue"
			   href="<?php echo get_permalink(); ?>"><span
					class="c-post-list__continue-text"><?php if ( $is_product ) { ?><?php esc_html_e( 'Details', 'goldish' ); ?><?php } else { ?><?php esc_html_e( 'Read More', 'goldish' ); ?><?php } ?></span>
