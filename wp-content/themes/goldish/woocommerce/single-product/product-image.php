...
<?php } else { ?>
	...
	<?php if ( $product_page_layout == 'layout-2' && ideapark_mod( 'product_gallery_layout' ) == 'desktop' ) { ?>
		<div
			data-hash="<?php echo esc_attr( $hash ); ?>"
			class="c-product__slider woocommerce-product-gallery h-fade c-product__slider--list c-product__slider--desktop">
			<?php echo ideapark_wrap( $images_html ); ?>
		</div>
	<?php } elseif ( $product_page_layout == 'layout-2' && ideapark_mod( 'product_gallery_layout' ) == 'carousel' ) { ?>
		<div
			data-hash="<?php echo esc_attr( $hash ); ?>"
			...
			<?php echo ideapark_wrap( $images_html ); ?>
			<?php $with_thumbs = true; ?>
		</div>
	<?php } else { ?>
		<div
			data-hash="<?php echo esc_attr( $hash ); ?>"
			data-layout="<?php echo esc_attr( $product_page_layout ); ?>"
			class="c-product__slider h-fade c-product__slider--carousel h-carousel h-carousel--inner h-carousel--hover h-carousel--dots-hide <?php ideapark_class( in_array( $product_page_layout, [
				'layout-1',
	...
	<?php if ( $with_thumbs && sizeof( $images ) > 1 ) { ?>
		<div
			data-layout="<?php echo esc_attr( $product_page_layout ); ?>"
