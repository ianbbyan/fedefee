...
<?php if ( is_product() ? is_active_sidebar( 'product-sidebar' ) : ( is_active_sidebar( 'shop-sidebar' ) || is_active_sidebar( 'filter-sidebar' ) ) ) { ?>
	<?php if ( ! is_product() ) {
		...
		?>
		<div
			class="c-sidebar c-shop-sidebar<?php if ( ideapark_mod( 'single_sidebar' ) ) { ?> c-shop-sidebar--single<?php } ?> <?php ideapark_class( $with_filter_desktop, 'c-shop-sidebar--desktop-filter', 'c-shop-sidebar--desktop-sidebar' ); ?> js-shop-sidebar <?php ideapark_class( $with_sidebar && ideapark_mod( 'sticky_sidebar' ), 'js-sticky-sidebar' ); ?>">
