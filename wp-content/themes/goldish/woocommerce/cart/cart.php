				...
				<div
					...
					<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>"
						...
						<span class="c-cart__shop-update">
							<input type="submit" class="c-button c-button--outline c-cart__shop-update-button<?php if (ideapark_mod( 'cart_auto_update' )) { ?> c-cart__shop-update-button--auto<?php } ?> button"
								   name="update_cart"
