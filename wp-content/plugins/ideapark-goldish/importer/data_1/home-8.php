...
$home_page_id = ( $page =  ideapark_get_page_by_title( 'Home 8' ) ) ? $page->ID : 0;
$footer_page_id = ( $page =  ideapark_get_page_by_title( 'Footer (pattern)', OBJECT, 'html_block' ) ) ? $page->ID : 0;
...
$theme_home = [
	'title'      => __( 'Home 8', 'ideapark-goldish' ),
	'screenshot' => 'home-8.jpg',
	'url'        => 'https://parkofideas.com/goldish/demo/home-8/',
	'mods'       => $mods,
	'options'    => $options,
];