...
//		'product_grid_text_mobile',
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'sale_only',
			[
				'label'        => __( 'On Sale', 'ideapark-goldish' ),
	...
	function type_list() {
		...
		if ( ideapark_mod( 'recently_enabled' ) ) {
			$list['recently_viewed_products'] = esc_html__( 'Recently Viewed Products', 'ideapark-goldish' );
		}

		$list['custom'] = esc_html__( 'Custom Woocommerce Shortcode', 'ideapark-goldish' );
