...
class Ideapark_Elementor_Circle_Text extends Widget_Base {
	...
	public function get_title() {
		return __( 'Circle Text', 'ideapark-goldish' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Circle Text', 'ideapark-goldish' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Add Your Text Here', 'ideapark-goldish' ),
			]
		);
		...
		$this->start_controls_section(
			'section_settings',
			[
				'label' => __( 'Circle Text Settings', 'ideapark-goldish' ),
		...
		$this->add_control(
			'circle_animation',
			[
				'label'      => __( 'Animation Duration (sec)', 'ideapark-goldish' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 's' ],
				'default'    => [
					'size' => 10,
		...
		$this->add_control(
			'padding',
			[
				'label'      => __( 'Padding', 'ideapark-goldish' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default'    => [
					'size' => 0,
		...
		$this->start_controls_section(
			'section_title_style',
			[
				'label' => __( 'Typography', 'ideapark-goldish' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'font_family',
			[
				'label'     => esc_html__( 'Family', 'ideapark-goldish' ),
		...
		$this->add_control(
			'font_size',
			[
				'label'      => esc_html__( 'Size', 'ideapark-goldish' ),
		...
		$this->add_control(
			'font_weight',
			[
				'label'     => esc_html__( 'Weight', 'ideapark-goldish' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					'100'    => '100 ' . esc_html__( '(Thin)', 'ideapark-goldish' ),
					'200'    => '200 ' . esc_html__( '(Extra Light)', 'ideapark-goldish' ),
					'300'    => '300 ' . esc_html__( '(Light)', 'ideapark-goldish' ),
					'400'    => '400 ' . esc_html__( '(Normal)', 'ideapark-goldish' ),
					'500'    => '500 ' . esc_html__( '(Medium)', 'ideapark-goldish' ),
					'600'    => '600 ' . esc_html__( '(Semi Bold)', 'ideapark-goldish' ),
					'700'    => '700 ' . esc_html__( '(Bold)', 'ideapark-goldish' ),
					'800'    => '800 ' . esc_html__( '(Extra Bold)', 'ideapark-goldish' ),
					'900'    => '900 ' . esc_html__( '(Black)', 'ideapark-goldish' ),
					''       => esc_html__( 'Default', 'ideapark-goldish' ),
					'normal' => esc_html__( 'Normal', 'ideapark-goldish' ),
					'bold'   => esc_html__( 'Bold', 'ideapark-goldish' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'text_transform',
			[
				'label'     => esc_html__( 'Transform', 'ideapark-goldish' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''           => esc_html__( 'Default', 'ideapark-goldish' ),
					'uppercase'  => esc_html__( 'Uppercase', 'ideapark-goldish' ),
					'lowercase'  => esc_html__( 'Lowercase', 'ideapark-goldish' ),
					'capitalize' => esc_html__( 'Capitalize', 'ideapark-goldish' ),
					'none'       => esc_html__( 'Normal', 'ideapark-goldish' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'font_style',
			[
				'label'     => esc_html__( 'Style', 'ideapark-goldish' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''        => esc_html__( 'Default', 'ideapark-goldish' ),
					'normal'  => esc_html__( 'Normal', 'ideapark-goldish' ),
					'italic'  => esc_html__( 'Italic', 'ideapark-goldish' ),
					'oblique' => esc_html__( 'Oblique', 'ideapark-goldish' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'letter_spacing',
			[
				'label'      => esc_html__( 'Letter Spacing', 'ideapark-goldish' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$this->add_control(
			'word_spacing',
			[
				'label'      => esc_html__( 'Word Spacing', 'ideapark-goldish' ),
				'type'       => Controls_Manager::SLIDER,
				'default'    => [
					'unit' => 'em',
				],
