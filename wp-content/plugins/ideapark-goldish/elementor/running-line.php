...
class Ideapark_Elementor_Running_Line extends Widget_Base {
	...
	public function get_title() {
		return __( 'Infinite Marquee', 'ideapark-goldish' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'gap',
			[
				'label'      => __( 'Gap between items', 'ideapark-goldish' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default'    => [
					'size' => 15,
		...
		$this->add_control(
			'inner_gap',
			[
				'label'      => __( 'Gap between icon and title', 'ideapark-goldish' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default'    => [
					'size' => 15,
		...
		$this->add_responsive_control(
			'separator_font_size',
			[
				'label'          => __( 'Separator Font Size', 'ideapark-goldish' ),
				'type'           => \Elementor\Controls_Manager::SLIDER,
				'range'          => [
					'px' => [
						'min' => 1,
